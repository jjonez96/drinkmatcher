// Add event listener to run these functions when the DOM is fully loaded
...
// Initialize an empty array to store drinks
let drinks = [];
...
// Function to display liked drinks and their details
const displayLikedDrinks = () => {
  ...
  const likedDrinksHTML = likedDrinks.map(
    (recipe, index) => `
        <div class="card mb-4">
      ...
      recipe.strDrink
          ...
          <div class="card-header dropdwn mb-4" id="drinkHeader${index}">
              <h5 class="mb-0">
                <button
                  class="btn btn-link"
            ...
            <b class="card-text">Category:</b> 
             ${recipe.strCategory}
            <br>
            <b class="card-text">Glass:</b>
             ${recipe.strGlass} 
            <br>
            <br>
  ...
  const clearAllButtonHTML = `
    <div class="text-center mb-4">
      <button class="btn btn-danger" data-toggle="modal" data-target="#confirmationModal">Clear All</button>
    </div>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header ">
            <h5 class="modal-title modalheading " id="confirmationModalLabel">Confirm Action</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            Are you sure you want to clear all liked drinks?
          </div>
          <div class="modal-footer d-flex justify-content-center">
            <button type="button" class="btn btn-secondary " data-dismiss="modal">Cancel</button>
            <button type="button" class="btn btn-danger " data-dismiss="modal" onclick="clearAllLikedDrinks()">Yes, Clear All</button>
          </div>
        </div>
      </div>
    </div>
  ...
  container.innerHTML = `
    <div class="container">
      <h1 class="text-center text-light">Liked Drinks</h1>
      <h4 class="text-center text-light"> Matches: ${likedDrinks.length} </h4>
      ${likedDrinks.length > 0 ? clearAllButtonHTML : ""}
      <div class="card-columns">
        ${likedDrinksHTML.join("")}
      </div>
    </div>
  `;
};
...
const displayMainPage = () => {
    ...
    <div class="container mt-5">
      ...
      <div class="card text-center" id="drinkCard">
        <div class="card-body">
          ...
          <div class="card mb-3">
            <div class="card-header dropdwn" id="drinkHeader">
              <h5 class="mb-0">
                <button
                  class="btn btn-link"
                  data-toggle="collapse"
            ...
            <div id="drinkInstructions" class="collapse" aria-labelledby="drinkHeader">
              <div class="card-body">
                <p class="card-text " id="drinkDescription"></p>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
            <b>Ingredients:</b>
              <div id="drinkIngredients" class="text-left mx-5">
              </div>
            </div>
            <div class="col-md-6">
            <b>Category:</b> 
  ...
  `;
  // Display the current drink details
  displayDrink();
};
